...
<body>
  ...
  <div class="container">
    <div class="row d-flex justify-content-center">
        ...
        <form class="col-md-8 bg-light rounded-pill px-4 py-3 text-uppercase font-weight-bold"  action="{{ route('register') }}" method='post' enctype="multipart/form-data">
          @csrf
          ...
          <button type="submit" class="btn btn-dark rounded-pill py-2 btn-block my-3">  {{ __('Confirmar') }}</button>
        </form>
    </div>
  </div>
